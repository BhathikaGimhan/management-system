...
export const AddProductModel = ({ handleOpen, open, handleLoading }) => {
          ...
          <DialogBody className="mb-1 flex flex-col gap-3 relative p-0 overflow-y-scroll px-7 pb-5 max-h-[500px]">
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col items-start w-full gap-3 mt-6 md:flex-row md:gap-20 md:mt-10">
                <div className="md:w-[40%] w-full mb-3">
                  ...
                  <div className="w-full">
                    ...
                    <Select
                      ...
                      value={filteredCategories.find(
                        (option) =>
                          option.value ===
                          formData.Item_Category_idItem_Category
                      )}
