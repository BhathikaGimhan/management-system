    ...
    <div dir="ltr">
      ...
      >
        <div className="mb-2 flex items-center relative gap-4 p-4 w-full z-50">
          ...
          ></span>
          <div
            className="w-[30px] aspect-square rounded-full bg-[#7335E5] absolute top-28 -right-[15px] z-100 hidden md:flex items-center justify-center pr-[3px] cursor-pointer"
        ...
        <div className="w-full relative overflow-y-scroll scrollbar-y-style overflow-x-hidden">
          ...
          <li className="list-none w-full flex gap-1 flex-col">
            {newNavigationItems.slice(8, 10).map((item, itemIndex) => {
              return (
                <NavItem
                  icon={item.icon}
                  currentUrl={currentUrl}
          ...
          <li className="list-none w-full flex gap-1 flex-col mt-16">
            {newNavigationItems.slice(10, 11).map((item, itemIndex) => {
              return (
                <NavItem
                  icon={item.icon}
                  currentUrl={currentUrl}
...
const NavItem = ({
  ...
  return (
    <div className={`flex w-full ${sidebarExpanded ? `pr-4` : `pr-3`}`}>
      {currentUrl === link ? (
        <div className="bg-[#7335E5] w-1 h-[45px] min-h-1 rounded-l-lg rounded-r-full"></div>
      ) : (
      ...
      <Link to={`${link !== "#" ? "/" + link : "#"}`} className={`ml-1 w-full`}>
        <div className="flex items-end flex-col">
          <ListItem
            ...
            className={`${
              currentUrl === link
                ? "focus:bg-[#7335E5] active:bg-[#7335E5] bg-[#7335E5] active:text-white focus:text-white text-white font-bold"
