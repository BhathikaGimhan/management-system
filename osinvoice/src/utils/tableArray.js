...
export const Debtors_Head = ["AGE", "DEALER", "OPEN ITEMS", "BALANCE", ""];
...
export const TABLE_HEAD_SALESMEN = [
  "Employee No",
  "Employee Name",
  "NIC",
  "ETF No",
...
export const TABLE_HEAD_DUE_PAYMENTS = [
  "Invoice Id",
  "Customer",
  "Date",
  "Term",
...
export const DUEPAYMENTS = [
  {
    Invoice_idInvoice: "INV001",
    customer: "Mr. Smith",
    date: "19-03-2024",
    Term: 1,
    Amount: 1222.22,
    Penalty_Amount: 50.0,
    Total_Pending_Amount: 50.0,
    Paid_Date: "19-03-2024",
    Paid_Amount: 50.0,
    Balance_Amount: 50.0,
    Status: 1,
  },
  {
    Invoice_idInvoice: "INV002",
    customer: "Mr. Smith",
    date: "19-03-2024",
    Term: 1,
    Amount: 1222.22,
...
export const TABLE_HEAD_ITEM_DETAIL_REPORT = [
  "Category",
  "Description",
  "Real Cost (LKR)",
  "Cost (LKR)",
